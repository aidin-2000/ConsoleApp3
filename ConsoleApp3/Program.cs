    ...
    static void Main(string[] args)
    {
       ...
       /// удаление 
        ...
        /* // Обновление информации о сотруднике
          ...
          Employee updatedEmployee = new Employee(12,"aidin",  "Аза", 2500m, "8am - 12pm");
          employeeController.UpdateEmployee(existingEmployee, updatedEmployee);
        */

        string filePath = "employees.txt";
       // EmployeeController employeeController33 = new EmployeeController(filePath);

        // Вызов метода для редактирования сотрудника с ID=1
       // employeeController.EditEmployee(12, "John Doe", 2, 3000.0m, "Monday-Friday");
