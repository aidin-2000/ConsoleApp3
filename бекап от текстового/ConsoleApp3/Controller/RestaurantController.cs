...
namespace ConsoleApp3.Controller
{
    public class RestaurantController
    {
        ...
        public void AddDishToMenu(string dishName, List<Ingredient> ingredients)
        {
            Dish newDish = new Dish(dishName, ingredients);
            restaurant.Menu.Add(newDish);
            Console.WriteLine($"Блюдо '{dishName}' успешно добавлено в меню.");
        }
